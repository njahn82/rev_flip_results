...
![](results_files/figure-docx/fig_6-1.png)<!-- -->
...
![Reverse-flip journals affiliated with scholarly societies and research institutions per publisher](results_files/figure-docx/fig_7-1.png)

Figure presents the countries where the scholarly societies and research organizations are located by publisher.

![](results_files/figure-docx/fig_8-1.png)<!-- -->
...
![Number of journals that converted from fully OA to a subscription-based business model per year, grouped by journal age at the time of the reverse flip](results_files/figure-docx/fig_9-1.png)
...
![Discipline by journal age at the time of reverse flip, shown as proportion of the total number of reverse flip journals in the dataset. The colored areas represent the distribution of journals per Discipline.](results_files/figure-docx/fig_10-1.png)
...
![Developement of publication volume two years before and after the reverse flip.](results_files/figure-docx/fig_11-1.png)
...
![Development of source normalized impact per paper (SNIP) value between two years before and after the reverse flip. Coordinate system limited to SNIP value 2.5](results_files/figure-docx/fig_12-1.png)
...
![Scatterplot of APC list prices in USD based on pricing information for the year before the reverse-flip and for journals offering an hybrid open access option at the second half of 2018. Fully OA journals denoted with 0 did not charge an APC.](results_files/figure-docx/fig_13-1.png)
...
![](results_files/figure-docx/fig_15-1.png)<!-- -->
